...
**/
   ...
   public CofinFin() {
      ...
      // complement is initialized to false by default
   ...
   public CofinFin union(CofinFin other) {
      ...
      // You have to construct a new TreeSet object for the result
      CofinFin result = new CofinFin();
      result.complement = this.complement;
      result.finite = (TreeSet<Integer>)this.finite.clone();

      if(result.complement && other.complement){
          result.finite.retainAll(other.finite);
      }else if(result.complement && !other.complement){
         result.finite.removeAll(other.finite);
      }else if(!result.complement && other.complement){
         result.finite = (TreeSet<Integer>)other.finite.clone();
         result.finite.removeAll(this.finite);
   ...
   public boolean isSubsetOf(CofinFin other) {
      ...
      /*
         ...
         returns true exactly when the set represented by this is
         a subset of the set represented by other; neither this nor
         other should be modified;
       ...
       */
      TreeSet<Integer> temp = (TreeSet<Integer>)this.finite.clone();
      if(this.complement && other.complement){
         return this.finite.containsAll(other.finite);
      }else if(!this.complement && other.complement){
         temp.retainAll(other.finite);
         return temp.isEmpty();
      }else if(this.complement && !other.complement){
         return false;
      }else{
         return other.finite.containsAll(this.finite);
      }
   ...
   **/
   TreeSet<Integer> temp = (TreeSet<Integer>)this.finite.clone();
   if(complement){
      throw new Exception("maximum called for cofinite receiver");
   }else if(finite.isEmpty()){
      throw new Exception("maximum called for empty receiver");
   }else {
   ...
   public int minimum() throws Exception {
      ...
      if(finite.isEmpty()){
         if(!complement) {
            throw new Exception("minimum called for empty receiver");
         }else{
            return 0;
         }
      }else if(!complement){
...
// these were older tests; I will put them inside a single try-catch block
// and add an int variable so you can figure out roughly where the exception
// was thrown
   ...
   newA = new CofinFin();
   newB = newA.complement();
   System.out.println("\nA is " + newA + "\nComplement is " + newB);
   newB.remove(0);
   System.out.println("\nA is " + newA + "\nB is " + newB);

   newA = new CofinFin(true, null);
   newB = newA.complement();
   System.out.println("\nA is " + newA + "\nComplement is " + newB);
   newB.add(0);
   System.out.println("\nA is " + newA + "\nB is " + newB);
   ...
   newA = new CofinFin(false, 0);
   newB = newA.complement();
   System.out.println("\nA is " + newA + "\nComplement is " + newB);
   newA.remove(0);
   System.out.println("\nA is " + newA + "\nB is " + newB);

   newA = new CofinFin(true, 0);
   newB = newA.complement();
   System.out.println("\nA is " + newA + "\nComplement is " + newB);
   newA.add(0);
   System.out.println("\nA is " + newA + "\nB is " + newB);
   ...
   newA = new CofinFin(false,1);
   newB = new CofinFin(false,2);
   newC = newA.union(newB);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nUnion result is "
   + newC);

   newA = new CofinFin(false,1);
   newB = new CofinFin(false,2);
   newC = newB.union(newA);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nUnion result is "
   + newC);

   newA = new CofinFin(false,0);
   newB = new CofinFin(true,0);
   newC = newA.union(newB);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nUnion result is "
   + newC);

   newA = new CofinFin(true,0);
   newB = new CofinFin(false,0);
   newC = newA.union(newB);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nUnion result is "
   + newC);

   newA = new CofinFin(true,0);
   newB = new CofinFin(true,1);
   newC = newA.union(newB);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nUnion result is "
   + newC);
   ...
   newA = new CofinFin(false,new int[]{1,2});
   newB = new CofinFin(false, new int[]{2,3});
   newC = newA.intersect(newB);
   ...
   newA = new CofinFin(false,new int[]{1,2,3});
   newB = new CofinFin(false,new int[]{1,3});
   res = newA.equals(newB);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nEquals result is "
   + res);

   newA = new CofinFin(false,new int[]{1,2,3});
   newB = new CofinFin(false,new int[]{1,3});
   res = newB.equals(newA);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nEquals result is "
   + res);

   newA = new CofinFin(true,new int[]{1,2,3});
   newB = new CofinFin(false,new int[]{4,5});
   res = newA.equals(newB);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nEquals result is "
   + res);
   ...
   newA = new CofinFin(true,new int[]{0,1});
   newB = new CofinFin(true,new int[]{0,1,2,3});
   res = newA.equals(newB);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nEquals result is "
   + res);
   ...
   newA = new CofinFin(false,new int[]{0,1});
   newB = new CofinFin(false,new int[]{0,1});
   res = newB.equals(newA);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nEquals result is "
   + res);

   newA = new CofinFin(true,new int[]{0,1});
   newB = new CofinFin(true,new int[]{0,1});
   res = newB.equals(newA);
   System.out.println("A is " +  newA + "\nB is " + newB + "\nEquals result is "
   + res);
   ...
   f.complement().isIn(19));
      ...
      System.out.println("An operation threw an exception.");
      System.out.println(e.toString());
      System.out.println("The value of whereAmI is " + whereAmI);
   }
